...
export const Body_contacts_import_contactsSchema = {
    properties: {
        file: {
            type: 'string',
    ...
    type: 'object',
    required: ['file'],
    title: 'Body_contacts-import_contacts'
} as const;
...
export const Body_uploads_upload_photo_endpointSchema = {
    properties: {
        file: {
            type: 'string',
            contentMediaType: 'application/octet-stream',
    ...
    type: 'object',
    required: ['file'],
    title: 'Body_uploads-upload_photo_endpoint'
} as const;

export const BulkExportRequestSchema = {
    properties: {
        ids: {
            anyOf: [
                {
